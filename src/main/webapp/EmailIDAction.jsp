...

{
	...
	String to = userDAO.getUserEmailID(userEmail);
	String subject = "아이디 찾기를 위한 절차입니다";
	String content = "아이디찾기를 위한 절차이니 다음 링크에 접속하여 진행해주세요 " + "<a href='" + host + "/FindIdAction.jsp?code="
                                    ...
                                    <div class="card-body">
                                        	<section class="container mt-3" style="max-width: 560px;">
													<div class="arert mt-4" role="alert">
																	아이디를 찾기위한 이메일을 보냈습니다 <br> 메일을 확인해주세요
