...
;(function(factory) {
            ...
            _.initials = {
                ...
                dates: {
                    ...
                    en: {
                        ...
                        noEventForToday: "게시물이 없어요 ㅠㅡㅠ ",
                        noEventForThisDay: "게시물이 없어요 ㅠㅡㅠ ",
        ...
        if (!_.$elements.calendarEl.html()) {
            ...
            // events
              markup += '<div class="calendar-events">'+
                            ...
                            '<input id = "copy-title" name = "days" type = "hidden">'+
                            '<input  class="btn btn-secondary" value = "해당 게시물로 가기" type ="submit">'+
                            '<form>'+
                        '</div>';
    ...
    EvoCalendar.prototype.buildEventList = function() {
        ...
        _.$elements.eventEl.find('.event-header > p').text(title);
         $('#copy-title').attr('value',_.$active.date);
                        ...
                        for (var j = 0; j < _.$label.days.length; j++) { // this loop is for weekdays (cells)
                            if (day <= _.monthLength && (i > 0 || j >= _.startingDay)) {
                                ...
                                var thisDay = _.formatDate(_.$label.months[_.$active.month]+' '+day+' '+_.$active.year, _.options.format);
                                  ...
                                  markup += '<div class="day" role="button" data-date-val="'+thisDay+'">'+day+'</div>';  markup += '</div>';
                                 markup += '<input type = "hidden" name = "days" value="'+thisDay+'">';        
