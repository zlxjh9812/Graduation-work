...
<html lang="ko">
   ...
   String sql = "select*from friends where (friendsID = ?) and (yNn = false);";
   ...
   ResultSet rs = pstmt.executeQuery();
    ...
    %>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    %>
                    		...
                    		<form method="post" action="acceptfriends.jsp" >
                        	<li>
                        	<%if(result1 == null) {%>
                        		...
                        		<%} %>
                        		<%=rs.getString("userID") %>님이 친구요청을 보냈습니다.
                    		 	<input type="hidden" name="myfrID" value=<%=rs.getString("userID") %> readonly>
                    		</li>
                    		<div class="btn">
                    			<input type="submit" value="친구수락">
                    			<input type="submit" value="친구거절" onclick='return delfriends(this.form);'>
                    		</div> 
                    	</form>
        ...
        <script> 
 			function delfriends(frm) { 
    			frm.action='deletefriends.jsp'; 
    			frm.submit(); 
    			return true; 
  			} 
		</script> 
