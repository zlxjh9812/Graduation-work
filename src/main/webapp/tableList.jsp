...
<html lang="ko">
   ...
   pstmt = conn.prepareStatement("select*from user where userID like ?  or  userID like ?  or userID like ? or userID like ? and userID not in( ? );");
	pstmt.setString(1,searchName);
	pstmt.setString(2,'%'+searchName);
	pstmt.setString(3,searchName+'%');
	pstmt.setString(4,'%'+searchName+'%');
	pstmt.setString(5,(String)session.getAttribute("userID"));
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.jsp">User Profile</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                     ...
                     <div class="friends">    
                       	<span>친구 찾기</span>
                       	<div> 
                        	<a  href="myfriends.jsp" style="text-decoration:none; color:white; background-color:#0d6efd; border-color:#0d6efd; font-size:20px;padding:5px; margin-bottom:20px;border-radius:10px; margin-top:20px;  ">내 친구 목록</a>
                   ...
                   <%
                    ...
                    %>
                                   ...
                                   <form method="post" action="requestFriendsAction.jsp" >
                        	<li><a  href="#">
                        	<%if(rs.getString("userPic") == not){ %>
                        		<img src="./img/kakao_1.jpg" alt="">
                        		<%}else{ %>
                        		<img src="profile/<%=rs.getString("userPic")%>">
                        		<%} %>
                        		<%=rs.getString("userID") %> 
                        		<input type="hidden" name="friendsID" value=<%=rs.getString("userID") %> readonly>
