			...
			<form method="post" action="updateAction.jsp" enctype="multipart/form-data">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						...
						<tr>
							<td><textarea class="form-control" placeholder="글 내용" name="bbsContent" maxlength="2048" style="height: 150px;"></textarea></td>
						</tr>
					</tbody>
				</table>
				<input type="hidden" name="bbsID" value="<%=bbsID%>" >
				<input type="submit" class="btn btn-primary pull-right" value="수정하기">
				<input type="submit" class="btn btn-primary pull-right" value="삭제하기" onclick="return deletechart(this.form)">
			</form>
		</div>
	</div>	
...
$(window).load(function () {
    $('body').sakura();
		...
		<script> 
 			function deletechart(frm) { 
    			frm.action='deleteAction.jsp'; 
    			frm.submit(); 
    			return true; 
  			} 
		</script>
